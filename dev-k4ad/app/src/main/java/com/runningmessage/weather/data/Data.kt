package com.runningmessage.weather.data
...
data class City(var zipCode: Long, val id: Long, val name: String, val coord: Coordinates, val country: String, val population: Int)
